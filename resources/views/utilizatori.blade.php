...
<x-app-layout>
    ...
    <div class="py-12">
        ...
        @if(session('success'))
    <div id="confirmation-message" class="flex items-center p-4 mb-4 text-blue-800 border-t-4 border-blue-300 bg-blue-50 dark:text-blue-400 dark:bg-gray-800 dark:border-blue-800" role="alert">
            ...
            <form action="{{ route('utilizatori.newuser') }}" method="POST" class="p-4 md:p-5">
                ...
                <div class="grid gap-4 mb-4 grid-cols-1">
                    ...
                    <div>
                        ...
                        <input type="text" name="timp_de_lucru" id="timp_de_lucru" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Norma de lucru" value="8">
                    </div>
                </div>
    ...
    <div id="userList">
        ...
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-1000 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">Timp prezenta stabilit</th>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$user->rfid_uid}}</td>
                    <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$user->departament}}</td>
                    <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$user->timp_de_lucru}} ore/zi</td>
                    <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$user->created}}</td>
                                ...
                                <button data-modal-target="edit-modal-{{ $user->id }}" data-modal-toggle="edit-modal-{{ $user->id }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline focus:outline-none" style="padding-right:15px;">Editare</button>
                                    ...
                                    <button data-modal-target="popup-modal{{$user->id}}" data-modal-toggle="popup-modal{{$user->id}}" class="font-medium text-red-600 dark:text-blue-500 hover:underline focus:outline-none">Stergere</button>
                                        ...
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-4 md:p-5 text-center">
                                                    ...
                                                    <form action="{{ route('utilizatori.destroy', $user->id)}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                    ...
                                                    <button type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" data-modal-hide="popup-modal{{$user->id}}">Inapoi</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" data-modal-toggle="edit-modal-{{ $user->id }}">
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                    </svg>
                    <span class="sr-only">Close modal</span>
            ...
            <form action="{{ route('utilizatori.update', $user->id) }}" method="POST" id="edit-form-{{ $user->id }}" class="p-4 md:p-5">
                ...
                <div class="grid gap-4 mb-4 grid-cols-1">
                    <div>
                        <label for="nume" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nume<span style="color: red;">*</span></label>
                        <input type="text" name="nume" id="nume" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter name" value="{{ $user->nume }}" required="">
                    </div>
                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">E-mail</label>
                        <input type="text" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter name" value="{{ $user->email }}" >
                    </div>
                    <div>
                        <label for="rfid_uid" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">UID Card<span style="color: red;">*</span></label>
                        <input type="text" name="rfid_uid" id="rfid_uid" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter UID Card" value="{{ $user->rfid_uid }}" required="">
                    </div>
                    <div>
                        <label for="departament" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Departament</label>
                        <input type="text" name="departament" id="departament" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter department" value="{{ $user->departament }}">
                    </div>
                    <div>
                        <label for="timp_de_lucru" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Timp de prezenta stabilit (ore/zi)</label>
                        <input type="text" name="timp_de_lucru" id="timp_de_lucru" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter working hours expected" value="{{ $user->timp_de_lucru }}">
                    </div>
                </div>
                <button type="submit" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                    Actualizati
  ...
  <span class="font-medium">Nu exista utilizatori inrolati!</span> Puteti adauga un utilizator nou prin apasarea butonului de Adaugare sau prin intermediul terminalului.
</div>
@endif
                </div>
            </div>
